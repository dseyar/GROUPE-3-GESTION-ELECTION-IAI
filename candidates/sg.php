...
<body>
    ...
    <heading class="voters_heading">
        <center><h1 class="yebga">Liste pour le poste de Secretaire General</h1>
           <center>
                ...
                <option value = "vtr.php">Trésorier</option>                
                <option disabled selected>Secretaire Generale</option>
