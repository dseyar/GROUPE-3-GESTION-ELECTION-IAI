    ...
    <div id="row">
		...
		?>
		  ...
		  <div class = "alert alert-info">
			...
			<div class = "alert alert-info">
			<div class="panel-heading"><center>Conseiller</center></div>
			<br/>
			<?php
				if(!$_SESSION['ua_id'])
					{
			...
			<div class = "alert alert-success" >
			<div class="panel-heading"><center>Charger des sports</center></div>
			<br />
			<?php
				if(!$_SESSION['ss_id'])
					{
			...
			<div class="panel-heading"><center>Charger des sorts</center></div>
			<br />
			<?php
				if(!$_SESSION['ea_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>Trésorier</center></div>
			<br />
			<?php
			...
			<div class = "alert alert-info" >
			<div class="panel-heading"><center>SECRETAIRE GENERALE</center></div>
			<br />
			<?php
				if(!$_SESSION['sg_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>VICE TRESAURIER</center></div>
			<br />
			<?php
				if(!$_SESSION['vtr_id'])
					{
			...
			<div class = "alert alert-info">
			<div class="panel-heading"><center>Transport & Accommodation</center></div>
			<br />
			<?php
				if(!$_SESSION['tas_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>Publicité</center></div>
			<br />
			<?php
				if(!$_SESSION['ps_id'])
					{
			...
			<div class = "alert alert-info">
			<div class="panel-heading"><center>Secretaire Academique</center></div>
			<br />
			<?php
				if(!$_SESSION['as_id'])
					{
			...
			<br />
                                    ...
                                    <div class="modal-body">
										<p><center>Voulez vous vraiment valider se voye? </center></p>
                                    </div>
									
									<div class="modal-footer"><center>
								<a href = "submit_vote.php"><button type = "submit" class="btn btn-success"><i class="icon-check"></i>&nbsp;OUI</button></a>
								<a href = "vote.php"><button class="btn btn-danger" aria-hidden="true"><i class="icon-remove icon-large"></i>&nbsp;Rentrer</button></a>
									</center></div>
                                    <!-- /.modal-content -->
