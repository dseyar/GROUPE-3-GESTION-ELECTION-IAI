...
<body>
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Secretaire des sports</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Charger du divertissement</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Secretaire Generale</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Charger des Transports & Accommodationss</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Charger des publicités</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
     ...
     <div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Secretaire Académique</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
     ...
     <hr/>
		...
		<center><button class = "btn btn-success ballot" type = "submit" name = "submit">Envoyer le vote</button></center>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</form>
</body>
