											...
											<h4 class="modal-title" id="myModalLabel">         
												<div class="panel panel-primary">
													<div class="panel-heading">
														<center>Editer les détalis de l'élève</center>
													</div>    
												</div>
											</h4>
										</div>
                                        ...
                                        <div class="modal-body">
											...
											<div class="form-group">
												<label>Account</label>
												 ...
												 <button name = "done" type="submit" class="btn btn-primary">Savegarder</button>
												 <button name = "cancel" type="reset" class="btn btn-success">sortir</button>
