				...
				<h4 class="modal-title" id="myModalLabel">         
					<div class="panel panel-primary">
						<div class="panel-heading">
							<center>Entrer lidentifiant de l'élève</center>
						</div>    
					</div>
				</h4>
			</div>
...
<div class="modal-body">										
				<form action="" method = "post" >	
					...
					<div class="form-group">
						<label>Années d'enregistrement</label>
							<input class="form-control" type ="date" name = "started" required="true">
					</div>
											
					<button name = "add" type="submit" class="btn btn-primary">Ajouter dans la base de données</button>
				</form>
			</div>
            <div class="modal-footer">
                <a  href = "current_students.php"><button type="button" class="btn btn-default" data-dismiss="modal">Rentrer</button></a>
            </div>
