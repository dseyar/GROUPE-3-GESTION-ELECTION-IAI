				...
				<h4 class="modal-title" id="myModalLabel">         
					<div class="panel panel-primary">
						<div class="panel-heading">
							<center>Entrer votre identifiant</center>
						</div>    
					</div>
				</h4>
			</div>
...
<div class="modal-body">										
				<form action="" method = "post" >	
					...
					<div class="form-group">
						<label> 1 année d'enregistrement</label>
							<input class="form-control" type ="date" name = "started" required="true">
					</div>
											
					<button name = "add" type="submit" class="btn btn-primary">Ajouter dans la base</button>
				</form>
			</div>
