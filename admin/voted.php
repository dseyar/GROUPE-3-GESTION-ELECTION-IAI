    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <a href=" " class = "btn btn-danger btn-outline"><i class = "fa fa-paw"></i> Vote de garcon(<?php echo $count3['total']?>)</a> 
                <a href=" " class = "btn btn-danger btn-outline"><i class = "fa fa-paw"></i> Vote de fille(<?php echo $count4['total']?>)</a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
